...
class RegistratonViewController: UIViewController {
    ...
    @objc private func didTapRegister(){
        ...
        AuthManager.shared.registerNewUser(email: email, userName: userName, password: password){resigtered in
...
extension RegistratonViewController: UITextFieldDelegate{
